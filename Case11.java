public class EmpWageMulCompanyInterfaceApporch {
	public final String company;
	public final int empRatePerHour;
	public final int numOfWorkingDays;
	public int totalEmpWage;
	public EmpWageMulCompanyInterfaceApporch(String company, int empRatePerHour,int numOfWorkingDays, int maxHourPerMonth) {
